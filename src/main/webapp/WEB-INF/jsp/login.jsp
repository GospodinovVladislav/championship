						...
						<div class="row">
							<div class="col-lg-12">
								...
								<form id="register-form" action="/championship/app/users/add" method="post" onsubmit="return validate()" role="form" style="display: none;" enctype="multipart/form-data">
									...
									<div class="form-group">
										<input type="text" name="first_name" onkeyup="isNameOk()" id="first_name" tabindex="1" class="first_name form-control" placeholder="First Name" value="">
										<span class="name_span"/>
									</div>
									<div class="form-group">
										<input type="text" name="last_name"  onkeyup="isLastNameOk()" id="last_name" tabindex="1" class="last_name form-control" placeholder="Last Name" value="">
										<span class="lastName_span"></span>
									</div>
									<div class="form-group">
									Upload Picture: <input type="file" onchange="readURL(this);" name="picture" accept="image/jpeg, image/png">
    		  						 <img id="img" style="display:none" align="right" src="#"/> <br><br>
									</div>
